...
export default function EjercicioSubrayado() {
  ...
  const irAEjercicios = () => {
    navigate('/ejercicios/transcripcion');
  };
      ...
      {fase === 'video' && (
        <div className="space-y-4">
          ...
          <video controls className="w-full rounded">
            <source src="/videos/tutorial-transcripcion.mp4" type="video/mp4" />
            Tu navegador no soporta video HTML5.
          </video>
          <button
            onClick={() => avanzarAFase('instrucciones')}
            className="mt-4 px-4 py-2 bg-teal-500 hover:bg-sky-700 text-white rounded"
          >
            Siguiente
          </button>
        </div>
